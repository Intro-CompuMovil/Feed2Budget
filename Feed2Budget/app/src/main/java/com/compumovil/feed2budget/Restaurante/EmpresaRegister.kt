...
class EmpresaRegister : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_empresa_register)
        ...
        btnRegister.setOnClickListener {
            ...
            if (email.isNotEmpty() && password.isNotEmpty() && firstName.isNotEmpty() && direccion.isNotEmpty()) {
                registerUser(
    ...
    private fun registerUser(email: String, password: String, firstName: String,direccion: String) {
    ...
    private fun saveUserDataToDatabase(userId: String, firstName: String, direccion: String) {
